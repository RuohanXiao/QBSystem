    ...
    <div :style="{height:'55px',backgroundColor: 'rgba(51, 255, 255, 0.1)',margin:'0 14px 0 14px'}" id="net">
      <Row type="flex" justify="space-between" class="code-row-bg" align="middle" :style="{height:'70px',paddingLeft:'10px'}">
        ...
        <Tooltip content="知识扩展" placement="bottom">
          <Icon class="icon iconfont icon-linkedby process-img DVSL-bar-btn DVSL-bar-btn-back" size="26" @click="expandNodeKnowledge"></Icon>
        </Tooltip>
        </Col>
        <Col span="1" align="middle" class="bottom">
        <Tooltip content="事件扩展" placement="bottom">
          <Icon class="icon iconfont icon-linkedby process-img DVSL-bar-btn DVSL-bar-btn-back" size="26" @click="expandNodeEvent"></Icon>
        </Tooltip>
        </Col>
        ...
        <Tooltip content="知识路径" placement="bottom">
          <Icon class="icon iconfont icon-path process-img DVSL-bar-btn DVSL-bar-btn-back" size="26" @click="showPath"></Icon>
        </Tooltip>
        </Col>
        <Col span="1" align="middle" class="bottom">
        ...
        <Tooltip content="删除其余节点" placement="bottom">
          <Icon class="icon iconfont icon-delete process-img DVSL-bar-btn DVSL-bar-btn-back" size="26" @click="removeOther"></Icon>
        </Tooltip>
        </Col>
        <Col align="middle">
        <div style="float:center;width: 1px;height: 25px; background: rgba(51, 255, 255, 0.2)"></div>
        ...
        <Tooltip content="自适应" placement="bottom">
          <Icon class="icon iconfont icon-quanping process-img DVSL-bar-btn DVSL-bar-btn-back" size="26" @click="fit"></Icon>
        </Tooltip>
        </Col>
      </Row>
    </div>
    <div :style="{border:'1px solid rgba(54, 102, 116, 0.5)',margin:'0 14px',backgroundColor:'rgba(0,0,0,0.5)'}">
      <div id="netchart" aria-autocomplete="true" :style="{minHeight:netheight}"></div>
    </div>
    </Col>
  ...
  export default {
    ...
    methods: {
      ...
      add() {
        ...
        //   linkArr.push({
        //     id: "line" + num + this.nextId,
        //     from: this.selectionId[num].id,
        //     to: "new" + this.nextId,
        ...
        (this.netchart = new NetChart({
          ...
          style: {
            ...
            nodeStyleFunction: function(node) {
              ...
              if (node.hovered){
                node.lineColor = node.data.lineColor ="rgba(51, 255, 255, 1)"; 
    ...
    mounted() {
      ...
      window.onresize = function() {
        ...
        this.netheight = (document.body.clientHeight * 0.99 - 64 - 70 - 45 - 20) * 0.8 - 55 + "px";
        this.netheightdiv = (document.body.clientHeight * 0.99 - 64 - 70 - 45 - 20) * 0.8 + "px";
      }
      this.netheight = (document.body.clientHeight * 0.99 - 64 - 70 - 45 - 20) * 0.8 - 55 + "px";
      this.netheightdiv = (document.body.clientHeight * 0.99 - 64 - 70 - 45 - 20) * 0.8 + "px";
